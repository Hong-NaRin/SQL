...
SELECT FIRST_NAME, SALARY AS 급여, SALARY+300 AS 인상급여 FROM EMPLOYEES;
...
SELECT FIRST_NAME || '' || LAST_NAME || '사원의 급여는 ' || SALARY ||'달러 입니다' AS 급여 FROM EMPLOYEES WHERE FIRST_NAME = 'Steven' AND LAST_NAME = 'King';
