...
SELECT 200 AS 번호, 'HONG' AS 이름, '서울시' AS 지역 FROM DUAL -- 첫번째를 따라가기 때문에 엘리어스 맞추면 됨 
UNION ALL
SELECT 300, 'LEE', '경기도' FROM DUAL
UNION ALL
SELECT EMPLOYEE_ID, LAST_NAME, '서울시' FROM EMPLOYEES; -- 컬럼 개수 맞춰주기
----------------------------------------------------------------------
